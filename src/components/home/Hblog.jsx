...
import { blog } from '../../dummydata'; // Ensure the correct path
...
const Hblog = () => {
  return (
    <Box sx={{ py: 8, background: '#f8f8f8' }}>
      ...
      <Typography variant="h3" component="div" sx={{ color: '#1eb2a6', fontWeight: 'bold', mt: 13, textAlign: 'center', mt: 6, mb: 2, }}>
        OUR BLOG
          </Typography>
