...
import Heading from "../../common/heading/Heading"; // Ensure this component is correctly imported
...
const Hero = () => {
  ...
  <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 2, marginTop: 4 }}>
    <Button variant="contained" size="large" endIcon={<ArrowForwardIosIcon />}
      sx={{
        backgroundColor: '#1eb2a6', // Button color
        color: 'white', // Text color
        '&:hover': {
          backgroundColor: '#16897b', // Manually chosen darker shade
        },
      }}>
      GET STARTED NOW
    </Button>
    <Button variant="outlined" size="large" endIcon={<ArrowForwardIosIcon />} 
      sx={{ 
        borderColor: '#1eb2a6', color: '#1eb2a6', 
        '&:hover': { 
